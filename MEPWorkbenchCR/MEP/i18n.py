...
_STRINGS = {
    "en": {
        ...
        "cmd.insert_evaporator.tooltip": "Insert a concrete evaporator model and auto-assign it to a space",
    ...
    "es": {
        ...
        "cmd.insert_evaporator.tooltip": "Insertar evaporadora concreta y asignarla automaticamente al recinto",
